document.addEventListener("DOMContentLoaded", () => {
    ...
    // Shared across the root index.html and every page inside /pages/ —
    // compute the right relative prefix for each case.
    ...
    Furni<span class="text-warning">Rent</span>
            ...
            <div class="footer-col">
                ...
                <ul class="footer-links list-unstyled text-white-50 lh-lg">
                    ...
                    <li><a href="${toPage}about.html" class="text-decoration-none text-white-50">About</a></li>

                    <li><a href="${toPage}catalog.html" class="text-decoration-none text-white-50">Catalog</a></li>

                    <li><a href="${toPage}pricing.html" class="text-decoration-none text-white-50">Pricing</a></li>

                    <li><a href="${toPage}blog.html" class="text-decoration-none text-white-50">Blog</a></li>
            ...
            <div class="footer-col">
                ...
                <ul class="footer-links list-unstyled text-white-50 lh-lg">
                    ...
                    <li><a href="${toPage}catalog.html?room=living-room" class="text-decoration-none text-white-50">Living Room</a></li>

                    <li><a href="${toPage}catalog.html?room=bedroom" class="text-decoration-none text-white-50">Bedroom</a></li>

                    <li><a href="${toPage}catalog.html?room=study" class="text-decoration-none text-white-50">Study</a></li>

                    <li><a href="${toPage}catalog.html?room=dining" class="text-decoration-none text-white-50">Kitchen & Dining</a></li>

                    <li><a href="${toPage}catalog.html?category=storage" class="text-decoration-none text-white-50">Storage</a></li>
